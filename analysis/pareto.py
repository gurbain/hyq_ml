...
def get_data(data, field_x, field_y):
    ...
    y_bad = []
    for d in data:
        if "roll" in field_y or "pitch" in field_y:
            if d[field_y] > 6.0:
                continue
        if bool(d["fallen"]):
            x_bad.append(eval(d[field_x])[0])
            y_bad.append(d[field_y])
        else:
...
def plot_pareto(data):
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_x_speed")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    plt.title("PERFORMANCE: X Speed")
    plt.xlabel('Compliance Gain [log scale]')
    plt.ylabel('Speed [m/s]')
    plt.xscale("log")
    plt.subplot2grid((5, 6), (0, 3), colspan=3, rowspan=1)
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_x_dist")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_COT")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_power")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_y_speed")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_y_dist")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_nrmse")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_average_computation_time")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_z_range")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_pitch_range")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
    ...
    xg, yg, xb, yb = get_data(data, "physics_init_impedance", "test_roll_range")
    plt.scatter(xb, yb, marker='*', facecolors='r', linewidths=0.01)
    plt.scatter(xg, yg, marker='o', facecolors='none', edgecolors='g')
